...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 66
    invoke-virtual {p1, v8, v5}, Landroid/content/Context;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    ...
    .line 74
    :cond_2
    invoke-static {p1, v1}, Lcom/android/settings/bluetooth/LocalBluetoothPreferences;->shouldShowDialogInForeground(Landroid/content/Context;Landroid/bluetooth/BluetoothDevice;)Z
    ...
    invoke-virtual {v8, v1}, Lcom/android/settingslib/bluetooth/CachedBluetoothDeviceManager;->isOngoingPairByCsip(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    invoke-virtual {v8, v1}, Lcom/android/settingslib/bluetooth/CachedBluetoothDeviceManager;->isLateBonding(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/settingslib/bluetooth/CachedBluetoothDeviceManager;->isLateBonding(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    :cond_6
    const-string v3, "android.bluetooth.action.CSIS_SET_MEMBER_AVAILABLE"
    ...
    const-string v0, "Receive ACTION_CSIS_SET_MEMBER_AVAILABLE"
    ...
    :cond_7
    const-string v0, "android.bluetooth.extra.CSIS_GROUP_ID"
    ...
    const-string v0, "GroupLeDeviceAdress"
    ...
    const-string v3, "mGroupDeviceAdress is "
    ...
    const-string v3, "mDevAdr1:"

    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v3, "mDevAdr2"
    ...
    invoke-virtual {p0, v1, p2}, Lcom/android/settingslib/bluetooth/CachedBluetoothDeviceManager;->pairDeviceByCsip(Landroid/bluetooth/BluetoothDevice;I)V
    :try_end_0
