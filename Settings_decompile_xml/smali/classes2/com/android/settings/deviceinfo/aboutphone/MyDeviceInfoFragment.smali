...
.method private static buildPreferenceControllers(Landroid/content/Context;Lcom/android/settings/deviceinfo/aboutphone/MyDeviceInfoFragment;Lcom/android/settingslib/core/lifecycle/Lifecycle;)Ljava/util/List;
    ...
    .line 206
    new-instance v1, Lcom/android/settings/deviceinfo/aboutphone/BatteryStatusController;

    const-string v4, "battery_status"

    invoke-direct {v1, p0, v4, p2}, Lcom/android/settings/deviceinfo/aboutphone/BatteryStatusController;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/settingslib/core/lifecycle/Lifecycle;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 207
    new-instance v1, Lcom/android/settings/deviceinfo/aboutphone/BatteryLevelController;

    const-string v4, "battery_level"

    invoke-direct {v1, p0, v4, p2}, Lcom/android/settings/deviceinfo/aboutphone/BatteryLevelController;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/settingslib/core/lifecycle/Lifecycle;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 208
    new-instance p2, Lcom/android/settings/deviceinfo/EidPreferenceController;

    invoke-direct {p2, p0}, Lcom/android/settings/deviceinfo/EidPreferenceController;-><init>(Landroid/content/Context;)V
    ...
    .line 224
    invoke-static {v4}, Lcom/android/settings/deviceinfo/simstatus/SlotSimStatus;->getPreferenceKey(I)Ljava/lang/String;
