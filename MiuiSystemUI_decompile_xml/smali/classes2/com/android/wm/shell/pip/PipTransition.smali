...
.method public final callFinishCallback(Landroid/window/WindowContainerTransaction;)V
    ...
    .line 2
    const-string v1, "callFinishCallback, wct : "
...
.method public final onFinishResize(Landroid/app/TaskInfo;Landroid/graphics/Rect;ILandroid/view/SurfaceControl$Transaction;)V
    ...
    .line 54
    iget-object v8, p0, Lcom/android/wm/shell/pip/PipTransition;->mSurfaceTransactionHelper:Lcom/android/wm/shell/pip/PipSurfaceTransactionHelper;

    .line 55
    if-eqz v7, :cond_5

    .line 57
    iget-boolean v3, p0, Lcom/android/wm/shell/pip/PipTransition;->mInFixedRotation:Z

    .line 59
    if-nez v3, :cond_4

    .line 61
    iget-object v3, p0, Lcom/android/wm/shell/pip/PipTransition;->mFinishTransaction:Landroid/view/SurfaceControl$Transaction;

    .line 63
    if-eqz v3, :cond_4

    .line 65
    invoke-virtual {v3, p4}, Landroid/view/SurfaceControl$Transaction;->merge(Landroid/view/SurfaceControl$Transaction;)Landroid/view/SurfaceControl$Transaction;
    ...
    .line 81
    iget-object v9, p1, Landroid/app/TaskInfo;->token:Landroid/window/WindowContainerToken;

    .line 83
    invoke-virtual {v7, v9, v5}, Landroid/window/WindowContainerTransaction;->setActivityWindowingMode(Landroid/window/WindowContainerToken;I)Landroid/window/WindowContainerTransaction;

    .line 85
    iget-object v9, p1, Landroid/app/TaskInfo;->token:Landroid/window/WindowContainerToken;

    .line 88
    invoke-virtual {v7, v9, p2}, Landroid/window/WindowContainerTransaction;->setBounds(Landroid/window/WindowContainerToken;Landroid/graphics/Rect;)Landroid/window/WindowContainerTransaction;
    ...
    .line 94
    invoke-virtual {v7, v9, v4}, Landroid/window/WindowContainerTransaction;->setBounds(Landroid/window/WindowContainerToken;Landroid/graphics/Rect;)Landroid/window/WindowContainerTransaction;
    ...
    .line 99
    invoke-virtual {v8, p2, v1, p4}, Lcom/android/wm/shell/pip/PipSurfaceTransactionHelper;->crop(Landroid/graphics/Rect;Landroid/view/SurfaceControl;Landroid/view/SurfaceControl$Transaction;)V

    .line 101
    invoke-virtual {v8, p2, v1, p4}, Lcom/android/wm/shell/pip/PipSurfaceTransactionHelper;->resetScale(Landroid/graphics/Rect;Landroid/view/SurfaceControl;Landroid/view/SurfaceControl$Transaction;)V

    .line 104
    invoke-virtual {v8, p4, v1, v3}, Lcom/android/wm/shell/pip/PipSurfaceTransactionHelper;->round(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Z)V

    .line 107
    :cond_7
    iget-object v3, p1, Landroid/app/TaskInfo;->token:Landroid/window/WindowContainerToken;

    .line 110
    invoke-virtual {v7, v3, p4}, Landroid/window/WindowContainerTransaction;->setBoundsChangeTransaction(Landroid/window/WindowContainerToken;Landroid/view/SurfaceControl$Transaction;)Landroid/window/WindowContainerTransaction;
    ...
    .line 135
    iget-object p4, p0, Lcom/android/wm/shell/pip/PipTransitionController;->mPipAnimationController:Lcom/android/wm/shell/pip/PipAnimationController;

    .line 137
    iget-object p4, p4, Lcom/android/wm/shell/pip/PipAnimationController;->mCurrentAnimator:Lcom/android/wm/shell/pip/PipAnimationController$PipTransitionAnimator;
    ...
    .line 149
    iget v6, p0, Lcom/android/wm/shell/pip/PipTransition;->mEndFixedRotation:I

    .line 152
    invoke-static {v3, v0, v6, p1}, Landroid/util/RotationUtils;->rotateBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;II)V
    ...
    .line 160
    invoke-virtual {v3, p4}, Landroid/graphics/Rect;->equals(Ljava/lang/Object;)Z
    ...
    .line 177
    const-string v10, "%s: Destination bounds were changed during animation"

    .line 180
    invoke-static {p4, v9, v5, v10, v6}, Lcom/android/wm/shell/protolog/ShellProtoLogImpl;->w(Lcom/android/wm/shell/protolog/ShellProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 185
    invoke-static {v3, v0, p4, p1}, Landroid/util/RotationUtils;->rotateBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;II)V

    .line 187
    iget-object p1, p0, Lcom/android/wm/shell/pip/PipTransition;->mFinishTransaction:Landroid/view/SurfaceControl$Transaction;

    .line 190
    invoke-virtual {v8, v3, v1, p1}, Lcom/android/wm/shell/pip/PipSurfaceTransactionHelper;->crop(Landroid/graphics/Rect;Landroid/view/SurfaceControl;Landroid/view/SurfaceControl$Transaction;)V
    ...
    .line 195
    invoke-virtual {p0, v7}, Lcom/android/wm/shell/pip/PipTransition;->callFinishCallback(Landroid/window/WindowContainerTransaction;)V
    ...
    .line 200
    iget-object p4, p0, Lcom/android/wm/shell/pip/PipTransitionController;->mPipMenuController:Lcom/android/wm/shell/pip/PipMenuController;

    .line 202
    invoke-interface {p4, v4, v4, p2, p1}, Lcom/android/wm/shell/pip/PipMenuController;->movePipMenu(Landroid/view/SurfaceControl;Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Rect;F)V

    .line 204
    invoke-interface {p4, p2}, Lcom/android/wm/shell/pip/PipMenuController;->updateMenuBounds(Landroid/graphics/Rect;)V

    .line 207
    new-instance p1, Ljava/lang/StringBuilder;

    .line 210
    const-string p4, "finish resize for leash : "
