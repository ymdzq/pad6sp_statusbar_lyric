...
# direct methods
.method public static synthetic $r8$lambda$15LkkcliM32Bk1pHtiVY7GfqX_w(Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController;Landroid/app/ActivityManager$RunningTaskInfo;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController;->lambda$getTopFullscreenTaskAndDispatch$0(Landroid/app/ActivityManager$RunningTaskInfo;)V
...
.method public static synthetic $r8$lambda$QnWMe_aNC9ndUro55hElPlCktJY(Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController;->lambda$getTopFullscreenTaskAndDispatch$1()V
...
.method public static synthetic $r8$lambda$SIV03gOrOhvFJE4y85PGO6KFNu4(Landroid/graphics/Rect;)I
    .locals 0

    .line 1
    invoke-static {p0}, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController;->lambda$dispatchWindowDecorRects$4(Landroid/graphics/Rect;)I
...
.method public static synthetic $r8$lambda$yHcyoj8dvxdOT0bhmsYTGARkg3M(Landroid/graphics/Rect;)I
    .locals 0

    .line 1
    invoke-static {p0}, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController;->lambda$dispatchWindowDecorRects$5(Landroid/graphics/Rect;)I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/wm/shell/common/ShellExecutor;Lcom/android/wm/shell/common/ShellExecutor;Ljava/util/Optional;Ljava/util/Optional;)V
    .locals 1
    ...
    .line 35
    iput-object p3, p0, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController;->mBgExecutor:Lcom/android/wm/shell/common/ShellExecutor;

    .line 37
    iput-object p4, p0, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController;->mSplitScreen:Ljava/util/Optional;

    .line 39
    iput-object p5, p0, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController;->mHideDisplayCutoutController:Ljava/util/Optional;
...
.method private static synthetic lambda$dispatchWindowDecorRects$4(Landroid/graphics/Rect;)I
    .locals 0
...
.method private static synthetic lambda$dispatchWindowDecorRects$5(Landroid/graphics/Rect;)I
    .locals 0
...
.method private synthetic lambda$getTopFullscreenTaskAndDispatch$0(Landroid/app/ActivityManager$RunningTaskInfo;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController;->dispatchFullScreenWindowDecorRect(Landroid/app/ActivityManager$RunningTaskInfo;)V
...
.method private synthetic lambda$getTopFullscreenTaskAndDispatch$1()V
    .locals 4
    ...
    .line 6
    invoke-virtual {v0, v1}, Landroid/app/ActivityTaskManager;->getTopVisibleTask(I)Landroid/app/ActivityManager$RunningTaskInfo;
    ...
    .line 11
    iget-object v1, p0, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController;->mMainExecutor:Lcom/android/wm/shell/common/ShellExecutor;

    .line 13
    new-instance v2, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController$$ExternalSyntheticLambda2;

    .line 15
    const/4 v3, 0x0

    .line 17
    invoke-direct {v2, v3, p0, v0}, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController$$ExternalSyntheticLambda2;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public dispatchWindowDecorRects(Ljava/util/List;)V
    ...
    .line 10
    :cond_0
    new-instance v0, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController$$ExternalSyntheticLambda1;

    .line 11
    const/4 v1, 0x0

    .line 13
    invoke-direct {v0, v1}, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController$$ExternalSyntheticLambda1;-><init>(I)V
    ...
    .line 20
    new-instance v1, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController$$ExternalSyntheticLambda1;

    .line 21
    const/4 v2, 0x1

    .line 23
    invoke-direct {v1, v2}, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController$$ExternalSyntheticLambda1;-><init>(I)V
...
.method public getTopFullscreenTaskAndDispatch()V
    .locals 2

    .line 1
    iget-object v0, p0, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController;->mBgExecutor:Lcom/android/wm/shell/common/ShellExecutor;
    ...
    .line 4
    invoke-direct {v1, p0}, Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController$$ExternalSyntheticLambda0;-><init>(Lcom/android/wm/shell/miuimultiwinswitch/miuiwindowdecor/WindowDecorRectController;)V
