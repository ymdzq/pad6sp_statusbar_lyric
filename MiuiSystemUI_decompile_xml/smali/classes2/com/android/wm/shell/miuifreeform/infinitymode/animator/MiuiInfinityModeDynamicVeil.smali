...
.method private setScreenProjectionFlag(Landroid/view/SurfaceControl;)V
    ...
    .line 11
    invoke-virtual {v0}, Lcom/xiaomi/screenprojection/IMiuiScreenProjectionStub;->getMiuiInScreeningSettingsKey()Ljava/lang/String;
    ...
    .line 27
    invoke-virtual {v0}, Lcom/xiaomi/screenprojection/IMiuiScreenProjectionStub;->getMiuiPrivacyOnSettingsKey()Ljava/lang/String;
    ...
    .line 38
    invoke-virtual {v0}, Lcom/xiaomi/screenprojection/IMiuiScreenProjectionStub;->getExtraScreenProjectFlag()I

    .line 40
    move-result p0

    .line 43
    invoke-virtual {p1, p0}, Landroid/view/SurfaceControl;->setScreenProjection(I)V
    ...
    .line 47
    :cond_0
    invoke-virtual {p1, v3}, Landroid/view/SurfaceControl;->setScreenProjection(I)V
...
.method public createSurface(Landroid/view/SurfaceControl$Transaction;)Landroid/view/SurfaceControl;
    ...
    .line 47
    invoke-direct {p0, v0}, Lcom/android/wm/shell/miuifreeform/infinitymode/animator/MiuiInfinityModeDynamicVeil;->setScreenProjectionFlag(Landroid/view/SurfaceControl;)V
    ...
    .line 73
    iput-object v1, p0, Lcom/android/wm/shell/miuifreeform/infinitymode/animator/MiuiInfinityModeDynamicVeil;->mBBQ:Landroid/graphics/BLASTBufferQueue;
    ...
    .line 81
    iput-object v1, p0, Lcom/android/wm/shell/miuifreeform/infinitymode/animator/MiuiInfinityModeDynamicVeil;->mSurface:Landroid/view/Surface;

    .line 82
    new-instance v1, Landroid/view/ThreadedRenderer$SimpleRenderer;
    ...
    .line 86
    const-string v3, "cvw renderer"

    .line 88
    iget-object v4, p0, Lcom/android/wm/shell/miuifreeform/infinitymode/animator/MiuiInfinityModeDynamicVeil;->mSurface:Landroid/view/Surface;

    .line 90
    invoke-direct {v1, v2, v3, v4}, Landroid/view/ThreadedRenderer$SimpleRenderer;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/view/Surface;)V

    .line 92
    iput-object v1, p0, Lcom/android/wm/shell/miuifreeform/infinitymode/animator/MiuiInfinityModeDynamicVeil;->mRenderer:Landroid/view/ThreadedRenderer$SimpleRenderer;

    .line 95
    const-string v1, "cvw overlay"
    ...
    .line 99
    invoke-virtual {p0, v1, v2}, Lcom/android/wm/shell/miuifreeform/infinitymode/animator/MiuiInfinityModeDynamicVeil;->createRenderNode(Ljava/lang/String;Landroid/graphics/Rect;)Landroid/graphics/RenderNode;

    .line 101
    move-result-object v1

    .line 104
    iput-object v1, p0, Lcom/android/wm/shell/miuifreeform/infinitymode/animator/MiuiInfinityModeDynamicVeil;->mRootNode:Landroid/graphics/RenderNode;

    .line 105
    iget-object v2, p0, Lcom/android/wm/shell/miuifreeform/infinitymode/animator/MiuiInfinityModeDynamicVeil;->mRenderer:Landroid/view/ThreadedRenderer$SimpleRenderer;

    .line 107
    invoke-virtual {v2, v1}, Landroid/view/ThreadedRenderer$SimpleRenderer;->setContentRoot(Landroid/graphics/RenderNode;)V

    .line 109
    invoke-virtual {p0, v0}, Lcom/android/wm/shell/miuifreeform/infinitymode/animator/MiuiInfinityModeSurfaceAnimable;->setSurfaceControl(Landroid/view/SurfaceControl;)V

    .line 112
    invoke-virtual {p0, p1}, Lcom/android/wm/shell/miuifreeform/infinitymode/animator/MiuiInfinityModeDynamicVeil;->attach(Landroid/view/SurfaceControl$Transaction;)Landroid/view/SurfaceControl;
...
.method public detach(Landroid/view/SurfaceControl$Transaction;)V
    ...
    .line 6
    sget-object v0, Lcom/android/wm/shell/miuifreeform/infinitymode/animator/MiuiInfinityModeDynamicVeil;->TAG:Ljava/lang/String;

    .line 8
    const-string v1, "hide dynamic veil."
