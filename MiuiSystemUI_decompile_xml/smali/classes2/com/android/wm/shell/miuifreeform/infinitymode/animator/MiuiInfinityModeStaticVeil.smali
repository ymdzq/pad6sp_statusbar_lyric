...
.method public attach(Landroid/view/SurfaceControl$Transaction;)Landroid/view/SurfaceControl;
    ...
    .line 12
    invoke-virtual {v0}, Lcom/android/wm/shell/miuifreeform/MiuiInfinityModeTaskWrapperInfo;->getBaseVisualBounds()Landroid/graphics/Rect;
    ...
    .line 102
    invoke-virtual {p1, v6, p0, v0}, Landroid/view/SurfaceControl$Transaction;->setPosition(Landroid/view/SurfaceControl;FF)Landroid/view/SurfaceControl$Transaction;

    .line 103
    invoke-virtual {p1, v6, v8, v8}, Landroid/view/SurfaceControl$Transaction;->setCornerRadius(Landroid/view/SurfaceControl;FF)Landroid/view/SurfaceControl$Transaction;
...
.method public attachOverlay(Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {v0, p0, v4}, Landroid/view/SurfaceControl$Transaction;->setTrustedOverlay(Landroid/view/SurfaceControl;Z)Landroid/view/SurfaceControl$Transaction;
...
.method public createSurface(Landroid/view/SurfaceControl$Transaction;)Landroid/view/SurfaceControl;
    ...
    .line 50
    invoke-direct {p0, v0}, Lcom/android/wm/shell/miuifreeform/infinitymode/animator/MiuiInfinityModeStaticVeil;->setScreenProjectionFlag(Landroid/view/SurfaceControl;)V
    ...
    .line 59
    invoke-virtual {p0, p1}, Lcom/android/wm/shell/miuifreeform/infinitymode/animator/MiuiInfinityModeStaticVeil;->attach(Landroid/view/SurfaceControl$Transaction;)Landroid/view/SurfaceControl;
...
.method public detach(Landroid/view/SurfaceControl$Transaction;)V
    ...
    .line 8
    const-string v1, "hide static veil."
