...
.field private mIsSwap:Z

.field private mScaleUpDownTransition:Lcom/android/wm/shell/common/transition/ScaleUpDownTransition;


# direct methods
.method public static synthetic $r8$lambda$K2LLXhYoGt4QRQIwzPm3gYUdh1A(Lcom/android/wm/shell/common/transition/DefaultTransitionImpl;Ljava/lang/Boolean;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/android/wm/shell/common/transition/DefaultTransitionImpl;->lambda$registerListener$0(Ljava/lang/Boolean;)V
...
.method public static constructor <clinit>()V
    ...
    .line 61
    const-string v0, "com.android.contacts/.ContactShortcut"

    .line 64
    invoke-virtual {v2, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 66
    const-string v0, "com.milink.service/com.milink.ui.activity.DisplayDialogActivity"

    .line 69
    invoke-virtual {v2, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 71
    const-string v0, "com.iflytek.inputmethod.miui/com.iflytek.inputmethod.mmp.MmpGetPicHelperActivity"

    .line 74
    invoke-virtual {v2, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 76
    const-string v0, "com.xiaomi.simactivate.service/com.xiaomi.activate.ui.ActivatePopupActivity"
...
.method public constructor <init>()V
    ...
    .line 12
    iput-boolean v0, p0, Lcom/android/wm/shell/common/transition/DefaultTransitionImpl;->mIsSwap:Z
...
.method private synthetic lambda$registerListener$0(Ljava/lang/Boolean;)V
    .locals 3
    ...
    .line 28
    iput-boolean v1, p0, Lcom/android/wm/shell/common/transition/DefaultTransitionImpl;->mIsSwap:Z

    .line 30
    const-string p0, "DefaultTransitionImpl"

    .line 32
    const-string p1, "Screen swap, need to start swap animation, mIsSwap = true"
...
.method public disableAnimation(Landroid/window/TransitionInfo;I)Z
    .locals 2
    ...
    .line 3
    invoke-virtual {p1}, Landroid/window/TransitionInfo;->isControllerAMonkey()Z
...
.method public registerListener(Ljava/util/concurrent/Executor;Landroid/content/Context;)V
    .locals 3
    ...
    .line 21
    new-instance v2, Lcom/android/wm/shell/common/transition/DefaultTransitionImpl$$ExternalSyntheticLambda0;

    .line 23
    invoke-direct {v2, p0}, Lcom/android/wm/shell/common/transition/DefaultTransitionImpl$$ExternalSyntheticLambda0;-><init>(Lcom/android/wm/shell/common/transition/DefaultTransitionImpl;)V

    .line 25
    invoke-direct {v1, p2, v2}, Landroid/hardware/devicestate/DeviceStateManager$FoldStateListener;-><init>(Landroid/content/Context;Ljava/util/function/Consumer;)V

    .line 28
    invoke-virtual {v0, p1, v1}, Landroid/hardware/devicestate/DeviceStateManager;->registerCallback(Ljava/util/concurrent/Executor;Landroid/hardware/devicestate/DeviceStateManager$DeviceStateCallback;)V
    ...
    .line 35
    const-string v0, "Do not register listener for swap animation: IS_FOLD_DEVICE = "
...
.method public replaceWithSwapAnimationIfNeeded(Landroid/view/animation/Animation;Z)Landroid/view/animation/Animation;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/android/wm/shell/common/transition/DefaultTransitionImpl;->shouldApplySwapAnimation()Z
...
.method public resetSwapStateIfNeeded()V
    .locals 1
    ...
    .line 11
    const-string v0, "Reset swap state, mIsSwap = false"
...
.method public shouldApplySwapAnimation()Z
    ...
    .line 1
    iget-boolean p0, p0, Lcom/android/wm/shell/common/transition/DefaultTransitionImpl;->mIsSwap:Z
...
.method public useDefaultAnimationAttr(Landroid/view/WindowManager$LayoutParams;ILandroid/window/TransitionInfo;Landroid/window/TransitionInfo$Change;)Z
    ...
    .line 19
    :goto_0
    sget-object v3, Lcom/android/wm/shell/common/transition/DefaultTransitionImpl;->WHITE_LIST_LIMIT_ALPHA_ANIMATION:Ljava/util/ArrayList;
