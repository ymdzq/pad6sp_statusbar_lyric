...
# direct methods
.method public static createThemedDialogContext(ZLandroid/content/Context;)Landroid/content/Context;
    .locals 1
    ...
    .line 2
    const p0, 0x7f040252    # @attr/dialogTheme
    ...
    .line 7
    :cond_0
    const p0, 0x7f04007f    # @attr/alertDialogTheme

    .line 8
    :goto_0
    invoke-static {p0, p1}, Landroidx/mediarouter/app/MediaRouterThemeHelper;->getThemeResource(ILandroid/content/Context;)I
    ...
    .line 17
    const p0, 0x7f0404f5    # @attr/mediaRouteTheme
...
.method public static createThemedDialogStyle(Landroid/content/Context;)I
    ...
    .line 1
    const v0, 0x7f0404f5    # @attr/mediaRouteTheme
...
.method public static getIconByAttrId(ILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    .line 25
    const v1, 0x7f0606f8    # @color/mr_dynamic_dialog_icon_light '#202124'
...
.method public static getRouterThemeId(Landroid/content/Context;)I
    ...
    .line 15
    const p0, 0x7f140553    # @style/Theme.MediaRouter.Light
    ...
    .line 20
    :cond_0
    const p0, 0x7f140554    # @style/Theme.MediaRouter.Light.DarkControlPanel
    ...
    .line 29
    const p0, 0x7f140555    # @style/Theme.MediaRouter.LightControlPanel
    ...
    .line 34
    :cond_2
    const p0, 0x7f140552    # @style/Theme.MediaRouter
...
.method public static setDialogBackgroundColor(Landroid/content/Context;Landroid/app/Dialog;)V
    ...
    .line 14
    const v0, 0x7f0606f4    # @color/mr_dynamic_dialog_background_light '#ffffff'
    ...
    .line 19
    :cond_0
    const v0, 0x7f0606f3    # @color/mr_dynamic_dialog_background_dark '#000000'
...
.method public static setIndeterminateProgressBarColor(Landroid/content/Context;Landroid/widget/ProgressBar;)V
    ...
    .line 13
    const v0, 0x7f0606f0    # @color/mr_cast_progressbar_progress_and_thumb_light '#4285f4'
    ...
    .line 18
    :cond_1
    const v0, 0x7f0606ef    # @color/mr_cast_progressbar_progress_and_thumb_dark '#5195ea'
