...
.method public declared-synchronized loadViewerConfig(Ljava/io/InputStream;)V
    ...
    .line 24
    iget-object v3, p0, Lcom/android/internal/protolog/ProtoLogViewerConfigReader;->mLogMessageMap:Ljava/util/Map;
...
.method public declared-synchronized loadViewerConfig(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    const-string v1, "Unable to load log definitions: JSON parsing exception while reading "

    const-string v2, "Unable to load log definitions: IOException while reading "

    const-string v3, "Unable to load log definitions: File "
    ...
    invoke-virtual {p0, v4}, Lcom/android/internal/protolog/ProtoLogViewerConfigReader;->loadViewerConfig(Ljava/io/InputStream;)V
    ...
    const-string v0, " log definitions from "
    ...
    invoke-static {p1, p2}, Lcom/android/internal/protolog/ProtoLogViewerConfigReader;->logAndPrintln(Ljava/io/PrintWriter;Ljava/lang/String;)V
