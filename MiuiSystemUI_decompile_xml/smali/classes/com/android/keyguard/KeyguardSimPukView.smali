...
.method public getPasswordTextViewId()I
    ...
    .line 1
    const p0, 0x7f0a0749    # @id/pukEntry
...
.method public final getPukPasswordErrorMessage(IZZ)Ljava/lang/String;
    ...
    .line 7
    const v0, 0x7f13061f    # @string/kg_password_wrong_puk_code_dead 'SIM is unusable. Contact your carrier.'
    ...
    .line 18
    const p2, 0x7f130619    # @string/kg_password_default_puk_message '{count, plural, =1 {SIM is now disabled. Enter PUK code to continue. You have # remaining attempt be ...'
    ...
    .line 23
    :cond_1
    const p2, 0x7f13061e    # @string/kg_password_wrong_puk_code '{count, plural, =1 {Incorrect SIM PUK code, you have # remaining attempt before SIM becomes permanen ...'
    ...
    .line 36
    const p2, 0x7f13063b    # @string/kg_puk_enter_puk_hint 'SIM is now disabled. Enter PUK code to continue. Contact carrier for details.'
    ...
    .line 41
    :cond_3
    const p2, 0x7f13061b    # @string/kg_password_puk_failed 'SIM PUK operation failed!'
    ...
    .line 58
    const p3, 0x7f13063d    # @string/kg_sim_lock_esim_instructions '%1$s Disable eSIM to use device without mobile service.'
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    .line 5
    const v0, 0x1040502    # @android:string/lockscreen_too_many_failed_attempts_dialog_message
