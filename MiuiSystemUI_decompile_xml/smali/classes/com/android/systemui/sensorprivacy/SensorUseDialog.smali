...
.method public constructor <init>(Landroid/content/Context;ILandroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnDismissListener;)V
    ...
    .line 30
    const v1, 0x7f0d0336    # @layout/sensor_use_started_title 'res/layout/sensor_use_started_title.xml'
    ...
    .line 38
    const v1, 0x7f0a085d    # @id/sensor_use_started_title_message
    ...
    .line 61
    :cond_0
    const v6, 0x7f130ac9    # @string/sensor_privacy_start_use_mic_camera_dialog_title 'Unblock device camera and microphone?'
    ...
    .line 65
    :cond_1
    const v6, 0x7f130ac3    # @string/sensor_privacy_start_use_camera_dialog_title 'Unblock device camera?'
    ...
    .line 69
    :cond_2
    const v6, 0x7f130acb    # @string/sensor_privacy_start_use_mic_dialog_title 'Unblock device microphone?'
    ...
    .line 73
    const v1, 0x7f0a085c    # @id/sensor_use_microphone_icon
    ...
    .line 95
    const v1, 0x7f0a085b    # @id/sensor_use_camera_icon
    ...
    .line 125
    :cond_7
    const p2, 0x7f130ac8    # @string/sensor_privacy_start_use_mic_camera_dialog_content 'This unblocks access for all apps and services allowed to use your camera or microphone.'
    ...
    .line 129
    :cond_8
    const p2, 0x7f130ac2    # @string/sensor_privacy_start_use_camera_dialog_content 'This unblocks access for all apps and services allowed to use your camera.'
    ...
    .line 133
    :cond_9
    const p2, 0x7f130aca    # @string/sensor_privacy_start_use_mic_dialog_content 'This unblocks access for all apps and services allowed to use your microphone.'
    ...
    .line 145
    const p2, 0x1040917    # @android:string/unsupported_compile_sdk_message
