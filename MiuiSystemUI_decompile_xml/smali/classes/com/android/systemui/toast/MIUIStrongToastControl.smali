...
.method public final showCustomStrongToast(Lcom/android/systemui/toast/bean/StrongToastModel;)V
    ...
    const v2, 0x7f0500b4    # @bool/support_strong_toast 'true'
    ...
    const v5, 0x7f071111    # @dimen/strong_toast_padding_default '18.0dp'
    ...
    const v5, 0x7f071112    # @dimen/strong_toast_padding_smail '9.0dp'
    ...
    const v5, 0x7f071110    # @dimen/strong_toast_padding_big '20.0dp'
    ...
    .line 74
    iget-object v9, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mCutOut:Landroid/view/View;
    ...
    const v11, 0x1050296    # @android:dimen/select_dialog_padding_start_material
    ...
    iput v10, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mContainerMargin:I
    ...
    .line 79
    iget-object v2, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mRLLeft:Landroid/widget/RelativeLayout;

    iget v4, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mContainerMargin:I

    invoke-virtual {v2, v4, v3, v3, v3}, Landroid/widget/RelativeLayout;->setPaddingRelative(IIII)V

    .line 80
    iget-object v2, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mRLRight:Landroid/widget/RelativeLayout;

    iget v4, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mContainerMargin:I

    invoke-virtual {v2, v3, v3, v4, v3}, Landroid/widget/RelativeLayout;->setPaddingRelative(IIII)V
    ...
    new-instance v4, Lcom/android/systemui/toast/MIUIStrongToast$$ExternalSyntheticLambda6;

    invoke-direct {v4, v0, v1}, Lcom/android/systemui/toast/MIUIStrongToast$$ExternalSyntheticLambda6;-><init>(Lcom/android/systemui/toast/MIUIStrongToast;Landroid/graphics/Rect;)V
    ...
    const-string v9, "MIUIStrongToast"
    ...
    invoke-virtual {v2, v10, v3, v3, v3}, Landroid/widget/RelativeLayout;->setPaddingRelative(IIII)V
    ...
    invoke-virtual {v2, v8, v3, v4, v3}, Landroid/view/View;->setPadding(IIII)V

    .line 87
    new-instance v2, Ljava/lang/StringBuilder;

    const-string v4, "Left.Cutout, append padding "
    ...
    iget v1, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mContainerMargin:I
    ...
    invoke-virtual {v2, v4, v3, v10, v3}, Landroid/view/View;->setPadding(IIII)V

    .line 92
    new-instance v2, Ljava/lang/StringBuilder;

    const-string v4, "Right.Cutout, append padding "
    ...
    .line 94
    iget-object v4, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mLeftImageView:Landroid/widget/ImageView;
    ...
    invoke-virtual {v9, v7}, Landroid/widget/ImageView;->setMinimumWidth(I)V
    ...
    .line 98
    iget-object v4, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mRightImageView:Landroid/widget/ImageView;
    ...
    .line 102
    iget-object v4, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mLeftVideoView:Lcom/android/systemui/toast/view/TextureVideoView;
    ...
    invoke-virtual {v9, v7}, Landroid/view/TextureView;->setMinimumWidth(I)V
    ...
    invoke-virtual {v7, v4}, Landroid/view/TextureView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 106
    iget-object v4, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mRightVideoView:Lcom/android/systemui/toast/view/TextureVideoView;
    ...
    .line 110
    iget-object v4, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mLeftContentWithOutText:Landroid/widget/FrameLayout;
    ...
    .line 111
    invoke-virtual {v4, v1}, Landroid/widget/RelativeLayout$LayoutParams;->setMarginEnd(I)V
    ...
    invoke-virtual {v9, v7}, Landroid/widget/FrameLayout;->setMinimumWidth(I)V
    ...
    .line 117
    iget-object v4, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mRightContentWithOutText:Landroid/widget/FrameLayout;
    ...
    iget v0, v0, Lcom/android/systemui/toast/MIUIStrongToast;->mScreenWidth:I
...
.method public final structureChargeStrongToast(Lcom/miui/charge/MiuiBatteryStatus;I)Landroid/os/Bundle;
    ...
    .line 49
    const v4, 0x7f130b3f    # @string/strong_toast_quick_charging 'Quick charging'
    ...
    .line 58
    :cond_2
    const v4, 0x7f130b3e    # @string/strong_toast_charging 'Charging'
